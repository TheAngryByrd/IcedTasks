        ...
        testList "ValueTaskBuilder" [
            testList "Return" [
                ...
                <| async {
                    ...
                    let! result = foo |> Async.AwaitValueTask
            ...
            testList "ReturnFrom" [
                ...
                <| async {
                    ...
                    do! outerTask |> Async.AwaitValueTask
                ...
                <| async {
                    ...
                    let! actual = outerTask |> Async.AwaitValueTask
        ...
        testList "functions" [
            testList "singleton" [
                ...
                <| async {
                    ...
                    let! someTask = innerCall |> Async.AwaitValueTask
