...
namespace IcedTasks
    ...
    type ColdTaskBuilderBase() =
        ...
        member inline _.Combine(task1: ColdTaskCode<'TOverall, unit>, task2: ColdTaskCode<'TOverall, 'T>) : ColdTaskCode<'TOverall, 'T> =
            ResumableCode.Combine(task1, task2)

        /// Builds a step that executes the body while the condition predicate is true.
        member inline _.While ([<InlineIfLambda>] condition : unit -> bool, body : ColdTaskCode<'TOverall, unit>) : ColdTaskCode<'TOverall, unit> =
            ResumableCode.While(condition, body)

        /// Wraps a step in a try/with. This catches exceptions both in the evaluation of the function
        /// to retrieve the step, and in the continuation of the step (if any).
        member inline _.TryWith (body: ColdTaskCode<'TOverall, 'T>, catch: exn -> ColdTaskCode<'TOverall, 'T>) : ColdTaskCode<'TOverall, 'T> =
            ResumableCode.TryWith(body, catch)

        /// Wraps a step in a try/finally. This catches exceptions both in the evaluation of the function
        /// to retrieve the step, and in the continuation of the step (if any).
        member inline _.TryFinally (body: ColdTaskCode<'TOverall, 'T>, [<InlineIfLambda>] compensation : unit -> unit) : ColdTaskCode<'TOverall, 'T> =
    ...
    #if NETSTANDARD2_1
        member inline internal this.TryFinallyAsync(body: ColdTaskCode<'TOverall, 'T>, compensation : unit -> ValueTask) : ColdTaskCode<'TOverall, 'T> =
        ...
        member inline this.Using<'Resource, 'TOverall, 'T when 'Resource :> IAsyncDisposable> (resource: 'Resource, body: 'Resource -> ColdTaskCode<'TOverall, 'T>) : ColdTaskCode<'TOverall, 'T> =
...
namespace IcedTasks.ColdTaskBuilderExtensions
    ...
    module LowPriority =
        ...
        type ColdTaskBuilderBase with
            ...
            static member inline BindDynamic< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall
                        ...
                        (sm: byref<_>, task: ^TaskLike, continuation: ('TResult1 -> ColdTaskCode<'TOverall, 'TResult2>)) : bool =
            ...
            member inline _.Bind< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall
                                                ...
                                                and ^Awaiter: (member get_IsCompleted:  unit -> bool)
                                                and ^Awaiter: (member GetResult:  unit ->  'TResult1)>
                        (task: ^TaskLike, continuation: ('TResult1 -> ColdTaskCode<'TOverall, 'TResult2>)) : ColdTaskCode<'TOverall, 'TResult2> =
                ...
                ColdTaskCode<'TOverall, _>(fun sm ->
                    if __useResumableCode then
                        ...
                        ColdTaskBuilderBase.BindDynamic< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall>(&sm, task, continuation)
                    //-- RESUMABLE CODE END
                )
            ...
            member inline this.ReturnFrom< ^TaskLike, ^Awaiter, 'T
                    ...
                    (task: ^TaskLike) : ColdTaskCode< 'T,  'T> =

                this.Bind(task, (fun v -> this.Return v))

            member inline _.Using<'Resource, 'TOverall, 'T when 'Resource :> IDisposable> (resource: 'Resource, body: 'Resource -> ColdTaskCode<'TOverall, 'T>) =
    ...
    module HighPriority =
        ...
        type ColdTaskBuilderBase with
            static member BindDynamic (sm: byref<_>, task: Task<'TResult1>, continuation: ('TResult1 -> ColdTaskCode<'TOverall, 'TResult2>)) : bool =
            ...
            member inline _.Bind (task: Task<'TResult1>, continuation: ('TResult1 -> ColdTaskCode<'TOverall, 'TResult2>)) : ColdTaskCode<'TOverall, 'TResult2> =
            ...
            member inline this.Bind (task: ColdTask<'TResult1>, continuation: ('TResult1 -> ColdTaskCode<'TOverall, 'TResult2>)) : ColdTaskCode<'TOverall, 'TResult2> =
    ...
    module MediumPriority =
        ...
        type ColdTaskBuilderBase with
            member inline this.Bind (computation: Async<'TResult1>, continuation: ('TResult1 -> ColdTaskCode<'TOverall, 'TResult2>)) : ColdTaskCode<'TOverall, 'TResult2> =
    ...
    module AsyncExtenions =
        type Microsoft.FSharp.Control.Async with
            static member AwaitColdTask (t : ColdTask<'T>) =
