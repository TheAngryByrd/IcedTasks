...
namespace IcedTasks
    ...
    type CancellableTaskBuilderBase() =
        ...
        member inline _.Combine(task1: CancellableTaskCode<'TOverall, unit>, task2: CancellableTaskCode<'TOverall, 'T>) : CancellableTaskCode<'TOverall, 'T> =
            ResumableCode.Combine(task1, task2)

        /// Builds a step that executes the body while the condition predicate is true.
        member inline _.While ([<InlineIfLambda>] condition : unit -> bool, body : CancellableTaskCode<'TOverall, unit>) : CancellableTaskCode<'TOverall, unit> =
            ResumableCode.While(condition, body)

        /// Wraps a step in a try/with. This catches exceptions both in the evaluation of the function
        /// to retrieve the step, and in the continuation of the step (if any).
        member inline _.TryWith (body: CancellableTaskCode<'TOverall, 'T>, catch: exn -> CancellableTaskCode<'TOverall, 'T>) : CancellableTaskCode<'TOverall, 'T> =
            ResumableCode.TryWith(body, catch)

        /// Wraps a step in a try/finally. This catches exceptions both in the evaluation of the function
        /// to retrieve the step, and in the continuation of the step (if any).
        member inline _.TryFinally (body: CancellableTaskCode<'TOverall, 'T>, [<InlineIfLambda>] compensation : unit -> unit) : CancellableTaskCode<'TOverall, 'T> =
            ResumableCode.TryFinally(body, ResumableCode<_,_>(fun _sm -> compensation(); true))

        member inline _.For (sequence : seq<'T>, body : 'T -> CancellableTaskCode<'TOverall, unit>) : CancellableTaskCode<'TOverall, unit> =
            ResumableCode.For(sequence, body)

    #if NETSTANDARD2_1
        member inline internal this.TryFinallyAsync(body: CancellableTaskCode<'TOverall, 'T>, compensation : unit -> ValueTask) : CancellableTaskCode<'TOverall, 'T> =
        ...
        member inline this.Using<'Resource, 'TOverall, 'T when 'Resource :> IAsyncDisposable> (resource: 'Resource, body: 'Resource -> CancellableTaskCode<'TOverall, 'T>) : CancellableTaskCode<'TOverall, 'T> =
    ...
    type CancellableTaskBuilder() =
        ...
        static member RunDynamic(code: CancellableTaskCode<'T, 'T>) : CancellableTask<'T> =
            fun (ct) ->
                ...
                let initialResumptionFunc = CancellableTaskResumptionFunc<'T>(fun sm -> code.Invoke(&sm))
                let resumptionInfo =
...
namespace IcedTasks.CancellableTaskBuilderExtensions
    ...
    module LowPriority =
        ...
        type CancellableTaskBuilderBase with
            ...
            static member inline BindDynamic< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall
                        ...
                        (sm: byref<ResumableStateMachine<CancellableTaskStateMachineData<'TOverall>>>, task: ^TaskLike, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : bool =
            ...
            static member inline BindDynamic< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall
                                                ...
                                                and ^Awaiter: (member get_IsCompleted:  unit -> bool)
                                                and ^Awaiter: (member GetResult:  unit ->  'TResult1)>
                        (sm: byref<ResumableStateMachine<CancellableTaskStateMachineData<'TOverall>>>, task: CancellationToken -> ^TaskLike, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : bool =
                    sm.Data.CancellationToken.ThrowIfCancellationRequested()
                    let mutable awaiter =
            ...
            member inline _.Bind< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall
                                                ...
                                                and ^Awaiter: (member get_IsCompleted:  unit -> bool)
                                                and ^Awaiter: (member GetResult:  unit ->  'TResult1)>
                        (task: ^TaskLike, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : CancellableTaskCode<'TOverall, 'TResult2> =
                ...
                CancellableTaskCode<'TOverall, _>(fun sm ->
                    if __useResumableCode then
                        ...
                        CancellableTaskBuilderBase.BindDynamic< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall>(&sm, task, continuation)
                    //-- RESUMABLE CODE END
                )
            ...
            member inline _.Bind< ^TaskLike, 'TResult1, 'TResult2, ^Awaiter , 'TOverall
                                                ...
                                                and ^Awaiter: (member get_IsCompleted:  unit -> bool)
                                                and ^Awaiter: (member GetResult:  unit ->  'TResult1)>
                        (task: CancellationToken -> ^TaskLike, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : CancellableTaskCode<'TOverall, 'TResult2> =
            ...
            member inline this.ReturnFrom< ^TaskLike, ^Awaiter, 'T
                    ...
                    (task: ^TaskLike) : CancellableTaskCode< 'T,  'T> =
            ...
            member inline this.ReturnFrom< ^TaskLike, ^Awaiter, 'T
                                                  ...
                                                  and ^Awaiter: (member get_IsCompleted: unit -> bool)
                                                  and ^Awaiter: (member GetResult: unit ->  'T)>
                    (task: CancellationToken -> ^TaskLike) : CancellableTaskCode< 'T,  'T> =

                this.Bind(task, (fun v -> this.Return v))

            member inline _.Using<'Resource, 'TOverall, 'T when 'Resource :> IDisposable> (resource: 'Resource, body: 'Resource -> CancellableTaskCode<'TOverall, 'T>) =
    ...
    module HighPriority =
        ...
        type CancellableTaskBuilderBase with
            static member BindDynamic (sm: byref<ResumableStateMachine<CancellableTaskStateMachineData<'TOverall>>>, task: CancellableTask<'TResult1>, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : bool =
                let mutable awaiter =
            ...
            member inline _.Bind (task: CancellableTask<'TResult1>, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : CancellableTaskCode<'TOverall, 'TResult2> =
    ...
    module MediumPriority =
        ...
        type CancellableTaskBuilderBase with
            ...
            member inline this.Bind (computation: Async<'TResult1>, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : CancellableTaskCode<'TOverall, 'TResult2> =
    ...
    module Priority4 =
        type CancellableTaskBuilderBase with
            member inline this.Bind (task: Task<'TResult1>, continuation: ('TResult1 -> CancellableTaskCode<'TOverall, 'TResult2>)) : CancellableTaskCode<'TOverall, 'TResult2> =
    ...
    module AsyncExtenions =
        ...
        type Microsoft.FSharp.Control.AsyncBuilder with
            ...
            member inline _.Source(cancellableTask: CancellableTask<'T>) : Async<'T> = Async.AwaitCancellableTask cancellableTask
            member inline _.Source(cancellableTask: CancellableTask) : Async<unit> = Async.AwaitCancellableTask cancellableTask
